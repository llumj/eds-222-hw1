...
The population is the entire pollution across Lahore. I.e. every single place would have a pollution associated with its location between November 2018 through November 2019.

2.  What are the *samples* in this setting? Please be precise.

The samples are government sourced and crowd sourced data 
...
Yes this was expected. The government is cookin' the books. In other words, they are possibly manipulating the data by selecting more favorable locations. Voluntary houses with sensors could be more affluent than others who did not participate and live in less polluted areas.  
...
air_mon_location <- ggplot() +
  ...
  labs(title = "Air Monitor locations around Lahore, Pakistan", x = "Longitude", y = "Latitude") +
   scale_color_manual("",values = c("Crowdsourced" = "red", "Government" = "blue"))
